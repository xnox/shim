...
%build
COMMIT_ID=b7bd97bfde2dbf98677f77e69d975c58703c1b0d
...
%ifarch x86_64
cd ../%{name}-%{version}-ia32
setarch i386 make 'DEFAULT_LOADER=\\\\grubia32.efi' ARCH=ia32 ${MAKEFLAGS} shimia32.efi mmia32.efi fbia32.efi
cd ../%{name}-%{version}-%{efiarch}
%endif
